...
- По ТЗ комментариев должно быть отображено не более 5 для изображения. (вероятно еще надо отобразить кнопку "Показать больше" или как там она называется)
...
а в строке 14 лучше оставить просто DOM элемент и тогда можно его обновлять через effectLevelValue.value = smth
А то у тебя он везде заново ищется

gallery.js строка 17. У нас в данных с сервера точно есть id?
